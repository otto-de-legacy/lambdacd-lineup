...
(defn validate [cfg]
  (let [val-result (first (b/validate cfg
                                      "urls" [is-map?
                                              ...
                                              [v/every #(b/valid? (val %) "env-mapping" [[v/every (fn [e] (clojure.core/string? (key e)))]])]
                                              [v/every #(b/valid? (val %) "env-mapping" [[v/every (fn [e] (not-empty (key e)))]])]
                                              [v/every #(b/valid? (val %) "env-mapping" [[v/every (fn [e] (clojure.core/string? (val e)))]])]
                                              [v/every #(b/valid? (val %) "cookies" [is-vector?])]
                                              [v/every #(b/valid? (val %) "cookies" [[v/every cookie-name-is-valid?]])]
                                              ...
                                              [v/every #(b/valid? (val %) "resolutions" [is-vector? no-duplicate-entries-in-vector? [v/every v/number]])]]
